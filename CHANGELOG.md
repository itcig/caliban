...
## [Unreleased](https://github.com/itcig/caliban/compare/v1.4.0...HEAD)

### Commits

- chore: remove composer.lock [`b63065b`](https://github.com/itcig/caliban/commit/b63065b7e7e96d85c742df3dd740c91cae84edfe)

## [v1.4.0](https://github.com/itcig/caliban/compare/v1.3.2...v1.4.0) - 2021-05-17

### Merged

- chore(deps): bump hosted-git-info from 2.8.8 to 2.8.9 [`#66`](https://github.com/itcig/caliban/pull/66)
- chore(deps): bump handlebars from 4.7.6 to 4.7.7 [`#65`](https://github.com/itcig/caliban/pull/65)
- chore(deps): bump ssri from 6.0.1 to 6.0.2 [`#64`](https://github.com/itcig/caliban/pull/64)
- chore(deps): bump y18n from 4.0.0 to 4.0.1 [`#63`](https://github.com/itcig/caliban/pull/63)
- chore(deps): bump elliptic from 6.5.3 to 6.5.4 [`#62`](https://github.com/itcig/caliban/pull/62)
- chore(deps): bump ini from 1.3.5 to 1.3.8 [`#61`](https://github.com/itcig/caliban/pull/61)
- fix: Fire sessionSet handlers if they arrive after init [`#67`](https://github.com/itcig/caliban/pull/67)

### Commits

- chore(deps): Update packages [`48dc225`](https://github.com/itcig/caliban/commit/48dc2258d3bd1ef68f5343acab213386cea0bc6c)
- chore(deps): Fix vulnerability with dep trim@0.0.1 [`6004da3`](https://github.com/itcig/caliban/commit/6004da36388e2b06802f12b52ca578ae5f93aba7)
- chore(release): Publish v1.4.0 [`7e757b2`](https://github.com/itcig/caliban/commit/7e757b299167e714f4b181aa17c7db0965068300)

## [v1.3.2](https://github.com/itcig/caliban/compare/v1.3.1...v1.3.2) - 2020-11-02
...
- chore(release): Publish v1.3.2 [`df38b6a`](https://github.com/itcig/caliban/commit/df38b6a7959340e115b080d815628ae54540433b)

## [v1.3.1](https://github.com/itcig/caliban/compare/v1.3.0...v1.3.1) - 2020-11-02

### Merged

- fix: Client params not being appended to form [`#59`](https://github.com/itcig/caliban/pull/59)
- chore(deps): bump node-fetch from 2.6.0 to 2.6.1 [`#58`](https://github.com/itcig/caliban/pull/58)

### Commits

- chore(release): Publish v1.3.1 [`02d71f9`](https://github.com/itcig/caliban/commit/02d71f9d9a0047dec581edb75cabe4e80e63ca2b)

## [v1.3.0](https://github.com/itcig/caliban/compare/v1.2.3...v1.3.0) - 2020-08-04

### Merged

- chore(deps): bump elliptic from 6.5.2 to 6.5.3 [`#55`](https://github.com/itcig/caliban/pull/55)
- fix: Check that extra cdata is iterable [`#57`](https://github.com/itcig/caliban/pull/57)
- feat: Set User Id + custom data [`#56`](https://github.com/itcig/caliban/pull/56)
- fix: Resolve bug with hyphens in session data keys [`#54`](https://github.com/itcig/caliban/pull/54)

### Commits

- chore(deps): Update all NPM packages [`1a18406`](https://github.com/itcig/caliban/commit/1a184060910ddafac269448ca467ab4164f14a11)
- chore(release): Publish v1.3.0 [`f2b515b`](https://github.com/itcig/caliban/commit/f2b515bed8ea853bbb707fe353be770ac2496af7)

## [v1.2.3](https://github.com/itcig/caliban/compare/v1.2.2...v1.2.3) - 2020-06-25

### Merged

- fix: Fix syntax with session Id lookup [`#52`](https://github.com/itcig/caliban/pull/52)

### Commits

- chore(release): Publish v1.2.3 [`4e772e6`](https://github.com/itcig/caliban/commit/4e772e6318ed6fc0ed39c29638fe238a084e3854)

## [v1.2.2](https://github.com/itcig/caliban/compare/v1.2.1...v1.2.2) - 2020-06-23

### Merged

- fix: Save debug container to cache [`#51`](https://github.com/itcig/caliban/pull/51)

### Commits

- chore(release): Publish v1.2.2 [`767b609`](https://github.com/itcig/caliban/commit/767b60902f511994f3c7be6d439b1e78e1333699)

## [v1.2.1](https://github.com/itcig/caliban/compare/v1.2.0...v1.2.1) - 2020-06-12

### Merged

- feat: Load local config after constructors [`#50`](https://github.com/itcig/caliban/pull/50)

### Commits

- chore(release): Publish v1.2.1 [`7858cf2`](https://github.com/itcig/caliban/commit/7858cf299436d2b52b58b07ef6e8d716d055a12f)

## [v1.2.0](https://github.com/itcig/caliban/compare/v1.1.10...v1.2.0) - 2020-06-12

### Merged

- feat: Added sessionSet event [`#49`](https://github.com/itcig/caliban/pull/49)

### Commits

- chore(release): Publish v1.2.0 [`73acc7e`](https://github.com/itcig/caliban/commit/73acc7e2b33d9d0162ab7798030606a5971bc4e8)

## [v1.1.10](https://github.com/itcig/caliban/compare/v1.1.9...v1.1.10) - 2020-04-27

### Merged

- feat: Do not alter/append named anchor links [`#46`](https://github.com/itcig/caliban/pull/46)

### Commits

- chore(release): Publish v1.1.10 [`ed2d6ed`](https://github.com/itcig/caliban/commit/ed2d6ed9ed1a9526749dfa9a2019aaeb16677897)
